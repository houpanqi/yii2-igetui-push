...
class IGeTui
{
    ...
    /**
     * Function:pushMessageToSingle 指定用户推送消息
     * @param $message
     * @param $target
    ...
    /**
     * Function:getSingleMessagePostData
    ...
    /**
     * Function:pushAPNMessageToSingle
     * @param $appId
     * @param $deviceToken
     * @param object $message
     * @return mixed|null
    ...
    /**
     * Function:getAPNContentId 获取apn contentId
     * @param $appId
     * @param object $message
     * @return mixed
     * @throws \Exception
